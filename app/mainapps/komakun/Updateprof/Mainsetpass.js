  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Setuserpassword')} style={styles.subakuncontainer}>
          ...
          <TouchableOpacity style={styles.subakuncontainer}  onPress={() => navigation.navigate('Setusrpin')}> 
                <Text style={styles.namasubakun}>Perubahan Pin</Text>
              <Ionicons style={styles.iconContainer} name="arrow-forward-outline" size={20} color="black" />
          </TouchableOpacity>
